                ...
                <CardContent>
                    {isLoading ? (
                        ...
                        <div className="space-y-6">
                            <Alert className="bg-yellow-500/10 border-yellow-500/50 text-yellow-900 dark:text-yellow-200">
                                <AlertTriangle className="h-4 w-4 text-yellow-500" />
                                <AlertTitle className="text-yellow-800 dark:text-yellow-300">Disclaimer</AlertTitle>
                                <AlertDescription>
